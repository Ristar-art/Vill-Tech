<script>
  ...
  $: targetAudience = courseCompetencies?.find(comp => comp.competency.shortname === 'Career Opportunities');
...
<div class="bg-white bg-opacity-90 rounded-tl-[40px] rounded-br-[40px] p-8 shadow-xl mb-8" >
    ...
    <div class="flex-grow">
      <h3 class="text-xl font-semibold text-[#222222] mb-2">{targetAudience?.competency?.shortname || 'Career Opportunities'}</h3>
