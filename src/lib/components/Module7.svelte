<script>
  ...
  $: module7 = courseCompetencies?.find(comp => comp.competency.shortname === 'MODULE 7');
...
<div class="bg-gray-50 p-6 rounded-lg shadow-md border border-gray-200 mt-6">
  <h3 class="text-xl font-semibold text-gray-800 mb-4">
    {module7?.competency?.shortname || 'MODULE 7'}
  </h3>

  {#if module7?.competency?.description}
    {@const content = cleanDescription(module7.competency.description)}
