<script>
  ...
  $: module1 = courseCompetencies?.find(comp => comp.competency.shortname === 'MODULE 1');
...
<div class="bg-gray-50 p-6 rounded-lg shadow-md border border-gray-200 mt-6">
  <h3 class="text-xl font-semibold text-gray-800 mb-4">
    {module1?.competency?.shortname || 'MODULE 1'}
  </h3>

  {#if module1?.competency?.description}
    {@const content = cleanDescription(module1.competency.description)}
