<script>
  ...
  $: targetAudience = courseCompetencies?.find(comp => comp.competency.shortname === 'Target Audience');
...
<div class="bg-white mt-6 p-6 rounded-lg shadow-md border border-gray-200">
  <div class="flex items-start gap-4">
    ...
    <div class="flex-grow">
      <h3 class="text-xl font-semibold text-[#222222] mb-2">{targetAudience?.competency?.shortname || 'Target Audience'}</h3>
