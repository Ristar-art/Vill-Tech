<script>
	...
	let cards = [
		...
		},
		{
			title: "Our Mission",
			content:
				"Our mission is to empower individuals through technology education and skills development, creating opportunities for sustainable employment and personal growth in underserved communities.",
			icon: `<svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 mb-3 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
		...
		},
		{
			title: "Our Impact",
			content:
				"Since our inception, we have trained over 1000 individuals, with 70% of our graduates securing employment or starting their own ventures within six months of completing our programs.",
			icon: `<svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 mb-3 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
		...
		},
		{
			title: "Our Future",
			content:
				"We are expanding our reach to more rural areas and developing new programs in emerging technologies to ensure our communities stay ahead in the digital age.",
			icon: `<svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 mb-3 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<svelte:head>
	...
	<meta
		name="description"
		content="Learn about Village Tech Training Solutions and our mission to empower through technology education"
	/>
</svelte:head>

<div class="min-h-screen py-16 w-full bg-[#21409A]">
	<div in:fade={{ duration: 1000 }}>
		<div
			class="relative h-[60vh] flex flex-col items-center justify-center pt-20 text-center text-white"
		>
			<div
...
>
	{#each cards as card, i}
		...
		>
			...
			<!-- Default State -->
			<div
				class="absolute inset-0 flex flex-col justify-center items-center p-6 transition-opacity duration-500 group-hover:opacity-0"
			>
				{@html card.icon}
			...
			>
				...
				<p
					class="text-sm leading-relaxed transform translate-y-4 transition-all duration-300 group-hover:translate-y-0"
				>
					{card.content}
				</p>
			</div>
