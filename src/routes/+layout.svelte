        ...
        <div class="container mx-auto px-4z-50 ">
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="text-center md:text-left">
                    <nav class="flex flex-row justify-center  space-x-6 text-white text-sm font-medium">
                      <a href="/" class="hover:text-gray-300 transition duration-300">Home</a>
                      <a href="/Courses" class="hover:text-gray-300 transition duration-300">Courses</a>
            ...
            <div class="border-t border-gray-300 mt-8 pt-6 text-center">
                <p class="text-white">&copy; 2024 Village Tech. All Rights Reserved.</p>
            </div>
        </div>
    </footer>
