<script>
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Attempt to login to MoodleCloud
            const moodleLoginResponse = await moodleClient.login(formData.email, formData.password);
            if (moodleLoginResponse.token) {
                // Handle successful MoodleCloud login
                ...
                <form on:submit={handleSubmit} class="space-y-4">
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-1">
                            ...
                            <a href="/ResetPassword" class="text-sm text-red-500 hover:text-red-600">
                                Forgot password?
                            </a>
                        </div>
                        <input
                    ...
                    <div class="text-center space-y-2">
                        ...
                        <div class="flex space-x-4 justify-center mt-4">
                            ...
                            <button
                                type="button"
                                class="flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
                                on:click={() => handleSocialLogin(facebookProvider)}
                            >
