...
<div class="min-h-screen bg-[#21409A]">
  {#if visible}
   ...
   <!-- Hero Section -->
<section 
  class="relative py-24 px-4 bg-cover bg-center bg-no-repeat"
  style="background-image: url('https://example.com/banner.jpg');" 
  in:fade={{ duration: 1000 }}
>
  <div class="max-w-7xl mx-auto text-center space-y-8 relative z-10">
    <h1 class="text-5xl md:text-6xl font-bold" in:fly={{ y: -50, duration: 800 }}>
      <span class="text-blue-400">Individual </span> 
      <span class="text-white">& Corporate</span>
      <span class="text-red-500">Training</span>
    </h1>
    
    <p class="text-xl text-white/80 max-w-2xl mx-auto" in:fly={{ y: 50, duration: 800, delay: 200 }}>
    ...
    <div class="flex flex-wrap justify-center gap-4 pt-8" in:fly={{ y: 50, duration: 800, delay: 400 }}>
      <button 
