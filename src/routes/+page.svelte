  ...
  const testimonials = [
    {
      ...
      name: "John Doe",
      role: "Web Developer",
      content: "The courses on EduOnline have been instrumental in advancing my career. The quality of instruction is top-notch!",
    ...
    },
    {
      ...
      name: "Jane Smith",
      role: "Data Analyst",
      content: "I love the flexibility of learning at my own pace. EduOnline has helped me acquire new skills while balancing my full-time job.",
      avatar: "/placeholder.svg?height=100&width=100",
    },
    {
      id: 3,
      ...
      content: "The digital marketing courses on EduOnline are up-to-date with the latest trends. It's been a game-changer for my business.",
      avatar: "/placeholder.svg?height=100&width=100",
    },
  ];
          ...
          <div class="space-y-6  flex flex-col justify-between">
            {#each benefits as benefit (benefit)}
              <div class="flex items-center space-x-2 px-6">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="white" class="h-5 w-5 animate-bounce">
                  <path fillRule="evenodd" d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clipRule="evenodd" />
                </svg>
                <p class="text-lg text-white">{benefit}</p>
              </div>
            {/each}
          </div>
        </div>
